...
var _geojsonToSvg = require('geojson-to-svg');

var _geojsonToSvg2 = _interopRequireDefault(_geojsonToSvg);
...
var vis = (0, _d.select)('#vis').append('svg').attr('width', width).attr('height', height);

(0, _d.json)('world.geojson', function (json) {
  // create a first guess for the projection
  var center = (0, _d.geoCentroid)(json);
  var scale = 150;
  var offset = [width / 2, height / 2];
  var projection = (0, _d.geoMercator)().scale(scale).center(center).translate(offset);
  ...
  // new projection
  projection = (0, _d.geoMercator)().center(center).scale(scale).translate(offset);
...
},{"d3":2,"geojson-to-svg":9}],2:[function(require,module,exports){
...
},{"./src/renderer":14}],10:[function(require,module,exports){
/**
...
},{"../fonts/arial_helvetica_sans-serif":4,"../fonts/georgia_times_serif":5,"../fonts/helvetica_arial_sans-serif":6,"../fonts/lucida_console_monaco_monospace":7,"../fonts/verdana_geneva_sans-serif":8,"./bbox":10,"./default_styles":11,"./get_font_data":12,"geojson-project":3,"json-extend":15,"string-hash":16,"transformation-matrix-js":17}],15:[function(require,module,exports){
(function ( GLOBAL ) {
